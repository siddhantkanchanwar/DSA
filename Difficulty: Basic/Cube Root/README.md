<h2><a href="https://www.geeksforgeeks.org/problems/cube-root-of-a-number0915/1?utm_medium=article_practice_tab&utm_campaign=article_practice_tab&utm_source=geeksforgeeks">Cube Root</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a number <strong>n</strong>, find the floor of cube root of<strong> n</strong>.</span></p>
